<template>
  <div>
    ...
    <!-- 添加分类的对话框 -->
    <el-dialog title="添加分类" :visible.sync="addCateDialogVisible" width="50%" @close="handleClose">
      <!-- 添加分类的表单 -->
      <el-form
        :model="addCateForm"
      ...
      >
        ...
        <el-form-item label="父级分类">
          <!-- 级联选择框,options用来指定数据源,props用来指定配置对象 -->
          <el-cascader
    ...
    <!-- 编辑分类的对话框 -->
    <el-dialog title="编辑分类" :visible.sync="editCateDialogVisible" width="50%" @close="editHandleClose">
      <!-- 添加分类的表单 -->
      <el-form
        :model="editCateForm"
